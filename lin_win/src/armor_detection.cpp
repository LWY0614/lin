...
//#define BINARY_SHOW                   输出  灰度图
//#define DRAW_LIGHTS_CONTOURS          输出  筛选前灯条轮廓图
//#define DRAW_LIGHTS_RRT               输出  筛选后
#define SHOW_NUMROI                   输出  装甲板ID
//#define DEBUG_DNN_PRINT
#define DRAW_ARMORS_RRT               输出  装甲板轮廓
//#define DRAW_FINAL_ARMOR_S_CLASS      输出  等级
#define SHOW_TIME                     输出  各个部分所用时间
...
//匹配灯条
//  1，匹配灯条。     条件 ：装甲版宽高比，左右灯条角度差，左右亮灯条中心点高度差，左右灯条的高度比，候选装甲板角度
//  2，筛选
//      判断2灯条中间有没有多的灯条
//  3，分辨大小装甲板
...
//清空数据          numROIs finalArmors candidateArmors candidateLights
//然后执行
//  1，图像预处理
//  2，找灯条
//  3，找装甲板
